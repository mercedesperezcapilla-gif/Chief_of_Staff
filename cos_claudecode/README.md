...
| [`scripts/gmail_helper.py`](scripts/gmail_helper.py) | Optional: multi-account Gmail OAuth helper (search/read/send across work + personal + side-project + ... via `--account <name>` flag) |
